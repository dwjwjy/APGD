...
class SetCriterion(nn.Module):
    ...
    def preprocess_targets(self, outputs: Dict[str, torch.Tensor],
        ...
        """
        bs, num_queries, num_classes = outputs['pred_logits'].shape # num_classes=256
        text_mask = outputs['text_mask']  # [bs, num_classes]
        device = outputs['pred_logits'].device
        # print(cls_labels,"ssssssssssssssssssssssssssssssssssssssssss")
        ...
        for batch_idx, (pred_indices, tgt_indices) in enumerate(indices):
            # print(batch_idx, pred_indices, tgt_indices)
            ...
            offset += num_targets
        # print(target_labels,"rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr")
    ...
    def loss_labels(self, outputs, targets, indices, log=False, **kwargs):
        ...
        # print(processed.target_labels[:,0:2,0:10],"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
        print(processed.pred_logits[:,0:2,0:10],"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
    ...
    def loss_boxes(self, outputs, targets, indices, **kwargs):
        ...
        # print(src_boxes,src_boxes.shape,"aaaaaaaaaaaaa")
        ...
        # print(tgt_boxes_list,"bbbbbbbbbbbbbbbb")
    ...
    def forward(self, outputs, targets, **kwargs):
        ...
        # print(outputs["pred_boxes"],"ooooooooooooooooooooooooooooooooooooooooooo")
        # print(targets["boxes"], targets["labels"],"tttttttttttttttttttttttttttttttttttttttttttt")
        indices, cls_labels = self.matcher(outputs, targets)
        # print(indices,cls_labels,cls_labels.shape,"ttttttttttttttttttttttttttttt")
